...
@fixture
def function_course(courses_client: CoursesClient, function_files: FilesFixture, function_user: UserFixture) -> CoursesFixture:
    request = CreateCourseRequestSchema(preview_file_id=function_files.response.file.id, created_by_user_id=function_user.response.user.id)
